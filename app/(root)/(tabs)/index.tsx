          ...
          <View>
            ...
            <View className="flex-row items-center justify-between px-5 pt-4 pb-5">
              ...
              <View className="items-end">
                <Text className="text-grey-900 text-sm font-medium">
                  Welcome back,
                </Text>
                <Text className="text-grey-900 text-base font-bold">
                  {user?.firstName ?? "User"}
                </Text>
              </View>
            </View>
            ...
            >
              ...
              <Text className="text-gray-400 text-sm flex-1">
                Search for properties, cities
              </Text>

              <TouchableOpacity
                onPress={() =>
                  router.push("/(root)/(tabs)/search?openFilter=true")
                }
                className="w-8 h-8 bg-blue-600 rounded-xl items-center justify-center"
              >
                <Ionicons name="options-outline" size={15} color="#9CA3AF" />
              </TouchableOpacity>
            </TouchableOpacity>
